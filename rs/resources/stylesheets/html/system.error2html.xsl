...
<!--<xsl:template match="/">
  <html><head><script language="JavaScript1.2" src="/resources/js/security.js"></script><title>Error</title></head><body>Se produjo un error: <xsl:value-of select="//error:message"/></body></html>
</xsl:template>-->
