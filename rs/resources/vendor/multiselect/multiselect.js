        ...
        Multiselect.prototype = {
            ...
            events: function() {
                ...
                self.$left.on('dblclick', 'option', function(e) {
                    ...
                    var $options = self.$left.find('option:selected:not(.hidden):enabled:visible');
                    if (isIE)
                    	$options = self.$left.find('option:selected:not(.hidden):enabled');
                    if ( $options.length ) {
                ...
                self.$right.on('dblclick', 'option', function(e) {
                    ...
                    var $options = self.$right.find('option:selected:not(.hidden):enabled:visible');
                    if (isIE)
                    	$options = self.$right.find('option:selected:not(.hidden):enabled');
                ...
                self.actions.$rightAll.on('click', function(e) {
                    ...
                    var $options = self.$left.children(':not(span):not(.hidden):enabled:visible');
                    if (isIE)
                    	$options = self.$left.find(':not(span):not(.hidden):enabled');
                ...
                self.actions.$leftAll.on('click', function(e) {
                    ...
                    var $options = self.$right.children(':not(span):not(.hidden):enabled:visible');
                    if (isIE)
                    	$options = self.$right.find(':not(span):not(.hidden):enabled');
                ...
                self.actions.$moveUp.on('click', function(e) {
                    ...
                    var $options = self.$right.find(':selected:not(span):not(.hidden):enabled:visible');
                    if (isIE)
                    	$options = self.$right.find(':selected:not(span):not(.hidden):enabled');
