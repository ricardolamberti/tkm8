...
//		return (w1 - w2);
    ...
    function Plugin (el, options) {
        ...
        base.init = function () {
            ...
            base.updateWidth();
            base.toggleHeadersWindow();

            base.$window.scroll(base.toggleHeadersWindow);
            base.$container.scroll(base.toggleHeadersWindow);
            base.$container.resize(base.toggleHeadersWindow);
            base.$container.resize(base.updateWidth);
        };

		base.toggleHeadersWindow = function () {
			...
			base.$el.each(function () {
				...
				var offsetw = $this.offset();
                var offset = base.getContainerOffset();
				var scrollTop = base.$window.scrollTop() + newTopOffset;
				var scrollLeft = base.$window.scrollLeft();

				if ((scrollTop > offsetw.top) && (scrollTop < offsetw.top + $this.height() - base.$clonedHeader.height())) {
					var newLeft = offsetw.left - scrollLeft;
        ...
        base.updateWidth = function () {
            ...
            $('th', base.$clonedHeader).each(function (index) {
               ...
               if ( $origCell.attr("style")==null ||  $origCell.attr("style").indexOf("width")==!-1) {
					$this.css({
						'min-width': $origCell.width()+18,
						'max-width': $origCell.width()+18,
						'padding': $origCell.css("padding"),
						'margin': $origCell.css("margin"),
						'style':  $origCell.attr("style")
					});
