...
// $Id: calendar.setup.js,v 1.2 2008/01/04 21:35:40 rlamberti Exp $
...
Calendar.setup = function (params) {
	...
	function onSelect(cal) {
		...
		if (cal.params.inputField) {
			...
			if (cal.params.inputField.onchange!=null) cal.params.inputField.onchange();
		}
	...
	triggerEl["on" + params.eventName] = function() {
		// ZEUS: added to validate input before showing the calendar
		if (document.getElementById(params.inputField.id).value!="" 
				&& !validateField(params.inputField.id)) return false;
