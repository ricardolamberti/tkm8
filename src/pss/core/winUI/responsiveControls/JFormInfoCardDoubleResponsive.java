...
public class JFormInfoCardDoubleResponsive extends JFormTwoPropertiesResponsive {
	...
	public JFormInfoCardDoubleResponsive setSubmit(boolean submit) {
		this.submit = submit;
		return this;
	}
	...
	public JFormInfoCardDoubleResponsive setClassHeaderImage(String classHeaderImage) {
	...
	public JFormInfoCardDoubleResponsive setClassHeaderText(String classHeaderText) {
	...
	public JFormInfoCardDoubleResponsive setImagen(JWebIcon imagen) {
		this.imagen = imagen;
		return this;
	}
	...
	public JFormInfoCardDoubleResponsive setAction(BizAction action) {
		this.action = action;
		return this;
	}
	...
	public JFormInfoCardDoubleResponsive setLabelLink(String labelLink) {
	...
	public JFormInfoCardDoubleResponsive setDataparent(String dataparent) {
	...
	// Constructor
	// -------------------------------------------------------------------------//
	public JFormInfoCardDoubleResponsive() {
	}
