...
public class GeoPosition implements Serializable {
    ...
    public org.jdesktop.swingx.mapviewer.GeoPosition getSwingGeoPosition() {
    	return new org.jdesktop.swingx.mapviewer.GeoPosition(this.latitude,this.longitude);
    }
    public static GeoPosition setSwingGeoPosition(org.jdesktop.swingx.mapviewer.GeoPosition from) {
