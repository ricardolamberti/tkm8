...
public class JXMLSerializer {
  ...
  public String toString(Element zNode) throws Exception {
    if (!(zNode instanceof Element)) JExcepcion.SendError("La implementaci�n de xml no es la deseada.");
...
protected String normalize(String s) {
  ...
  // @author IRA
  // Perd�n por esta funcion horrible y mal hecha.
  // Hay que buscar una auxiliar en alg�n paquete de XML que encode� un String a un String en ISO-8859-1
