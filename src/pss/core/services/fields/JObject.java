...
public class JObject<T extends Serializable> extends JBaseObject {
  ...
  public boolean isHibernate() {
	 ...
	 * representaci�n interna del valor como String; esta es la representaci�n
	 * usada por la base de datos, y nunca debe llegar al usuario;
	 * 
	 * #toStringOrig() --> igual que #toString(), pero sin aplicar el m�todo
	 * #Pre();
	 * 
	 * #toFormattedString() --> para obtener la representaci�n del valor que debe
	 * ver el usuario; �sta sale de aplicar regional formatters en los casos que
	 * corresponda
	 * 
	 * #toFormattedStringOrig() --> igual que #toFormattedString(), pero sin
	 * aplicar el m�todo #Pre();
	 * 
	 */
