...
public class GraphStBar2D extends GraphMatrix {
	...
	public GraphStBar2D(String title) {
		super(title);
	}
	...
	public String getImage(int pwidth, int pheight) throws Exception {
		...
		JIterator<Dataset> ids = getDatasets().getValueIterator();
			...
			JFreeChart chart = ChartFactory.createStackedBarChart(getTitle(), getAtributtes().getElement(GRAPH_ATTR_XAXISNAME), 
