...
public class GraphStCol3D extends GraphMatrix {
	...
	public GraphStCol3D(String title) {
		super(title);
	}
	...
	public String getImage(int pwidth, int pheight) throws Exception {
		...
		JIterator<Dataset> ids = getDatasets().getValueIterator();
			...
			JFreeChart chart = ChartFactory.createStackedBarChart3D(getTitle(), getAtributtes().getElement(GRAPH_ATTR_XAXISNAME), 
