...
public class GraphColumn3D extends GraphVector {
	...
	public GraphColumn3D(String title) {
		super(title);
	}
	...
	public String getImage(int pwidth, int pheight) throws Exception {
		...
		JFreeChart chart = ChartFactory.createBarChart3D(getTitle(), getAtributtes().getElement(GRAPH_ATTR_XAXISNAME), 
...
//    chart.draw(g2, r);
//    File f = new File("c:\\dev\\CanvasBarChartDemo1.html");
