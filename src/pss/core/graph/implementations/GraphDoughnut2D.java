...
public class GraphDoughnut2D extends GraphVector {
	...
	public GraphDoughnut2D(String title) {
		super(title);
	}
    ...
    DefaultPieDataset dataset = new DefaultPieDataset();
		...
		while (ids.hasMoreElements()) {
		    ...
		    dataset.setValue(ds.getColname(), Float.parseFloat(v.getData().toString().equals("")?"0":v.getData().toString()));
			}		
		}

		JFreeChart chart = ChartFactory.createRingChart(getTitle(), dataset, true, true, false);   
