...
public class JPssEdit extends JTextField {
	...
	public JPssEdit(String zType) {
		super();
		PssEditInit(zType, Integer.MAX_VALUE, 0, null);
	}

	public JPssEdit(int zMaxSize) {
		super();
		PssEditInit(JObject.JSTRING, zMaxSize, 0, null);
	}

	public JPssEdit(String zType, int zMaxSize) {
		super();
		PssEditInit(zType, zMaxSize, 0, null);
	}

	public JPssEdit(String zType, int zMaxSize, String zAtributo) {
		super();
		PssEditInit(zType, zMaxSize, 0, zAtributo);
	}

	public JPssEdit(String zType, int zMaxSize, int zPrecision, String zAtributo) {
		super();
