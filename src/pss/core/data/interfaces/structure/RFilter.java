...
//	}
	...
	public Serializable getObjValue() throws Exception {
		return sValor;
	}
	...
	public void setValue(Serializable s) {
		sValor=s;
	}
	...
	public boolean isParentesis() {
		return sAgrup!=null && (sAgrup.equals("(") || sAgrup.equals(")"));
	}

	public boolean isStartParentesis() {
		return sAgrup!=null && sAgrup.equals("(");
	}
	public boolean isEndParentesis() {
		return sAgrup!=null && sAgrup.equals(")");
	}
	...
	public RFilter setDynamic(boolean b) {
		dynamic=b;
		return this;
	}
