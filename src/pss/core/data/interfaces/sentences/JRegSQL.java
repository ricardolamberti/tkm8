...
//			throw new JNoFieldException();
	...
	/*
	 * Funci�n implementada para identificar la implementaci�n de la base de datos, en algunos casos es necesario identificarla para determinar la sintaxis de la sentencia SQL a ejecutar.
	 */
