...
public class JBaseJDBCImpl extends JBaseJDBC {
	...
	private static final String CONNECTION_IMPL = "pss.core.data.implementation.h2.JPssConnectionImpl";
	private static final String ROW_IMPL = "pss.core.data.implementation.h2.JRegJDBCImpl";
	...
	protected void initializeVirtualClassesNames() {
		systemDBFieldImpl = new String("pss.common.dbManagement.synchro.h2.JH2SystemDBField");
		systemDBFieldsImpl = new String("pss.common.dbManagement.synchro.h2.JH2SystemDBFields");
		systemDBIndexImpl = new String("pss.common.dbManagement.synchro.h2.JH2ystemDBIndex");
		systemDBIndexesImpl = new String("pss.common.dbManagement.synchro.h2.JH2SystemDBIndexes");
		systemDBTableImpl = new String("pss.common.dbManagement.synchro.h2.JH2SystemDBTable");
		systemDBTablesImpl = new String("pss.common.dbManagement.synchro.h2.JH2SystemDBTables");
		virtualDBFieldImpl = new String("pss.common.dbManagement.synchro.h2.JH2VirtualDBField");
		virtualDBFieldsImpl = new String("pss.common.dbManagement.synchro.h2.JH2VirtualDBFields");
		virtualDBIndexImpl = new String("pss.common.dbManagement.synchro.h2.JH2VirtualDBIndex");
		virtualDBIndexesImpl = new String("pss.common.dbManagement.synchro.h2.JH2VirtualDBIndexes");
		virtualDBTableImpl = new String("pss.common.dbManagement.synchro.h2.JH2VirtualDBTable");
	}
