...
//	  this.addItem( "tel_celular", pTelefonoCelular );
	...
	public void createFixedProperties() throws Exception {
		...
		addFixedItem(FIELD, "description", "Descripci�n", true, true, 500);
...
//		}
	...
	public static String getDescrTipoPersona(String tipo) throws Exception {
		if (tipo.equals(BizPersona.TIPO_FISICA)) return "Persona F�sica";
		if (tipo.equals(BizPersona.TIPO_JURIDICA)) return "Persona Jur�dica";
		return "";
	}
	...
	public void processUnificar(JRecords pers) throws Exception {
		if (pers.sizeStaticElements()<=1) 
			JExcepcion.SendError("Funcion habilitada unicamente para unificar dos � m�s personas");
	...
	public int getIndexOfMasterPersona(JRecords pers) throws Exception {
		...
		if (master_qty>1)  JExcepcion.SendError("No puede haber m�s de una persona maestra ");
		return ret_index ;
	}
