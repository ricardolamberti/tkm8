...
public class GuiBackUpMainSettings extends JWins {
   ...
   */
  public GuiBackUpMainSettings() throws Exception {
  }
  ...
  public Class<? extends JWin>  GetClassWin()                   { return GuiBackUpMainSetting.class; }
  /**
