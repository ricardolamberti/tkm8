...
//	public static final String CURRENCY = "Currency";
  ...
  @Override
	public String  GetTitle()    throws Exception  { return "Moneda Pa�s"; }
  @Override
...
//    this.addAction(8, "Pa�s", null, 1, true, true );
//    this.addAction( 10, "Cotizaciones" , null, 5041, false, false, true, "Detail");
//    this.addAction( 15, "Cambio de Cotizaci�n" , null , 708 , true, true);
