...
public class GuiMonedaFechas extends GuiMonedaCotizaciones {
  /**
   * Constructor de la Clase
   */
  public GuiMonedaFechas() throws Exception {
  }
  @Override
	public Class<? extends JWin>   GetClassWin() { return GuiMonedaFecha.class; }
  /**
