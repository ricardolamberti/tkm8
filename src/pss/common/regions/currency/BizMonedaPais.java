...
//		addFixedItem(VIRTUAL, "cotiz_venta", "Cotizaci�n Venta", true, true, 11, 4);
//		addFixedItem(VIRTUAL, "cotiz_compra", "Cotizaci�n Compra", true, true, 11, 4);
//		addFixedItem(VIRTUAL, "cotiz_contab", "Cotizaci�n Contable", true, true, 11, 4);
...
//	}
	...
	public void processDelete() throws Exception {
		if (JRecords.existsComplete("pss.erp.cashDrawer.BizCajaValor", "company", pCompany.getValue(), "country", pPais.getValue(), "moneda", pMoneda.getValue())) 
			JExcepcion.SendError("No se puede eliminar una relaci�n Moneda-Pa�s que est� asociado a un Tipo de Valor en el m�dulo de Cajas");
		if (JRecords.existsComplete("pss.erp.MedioPago.BizFormaPago", "company", pCompany.getValue(), "pais", pPais.getValue(), "sistema_pago", "MONEDA", "vinc1", pMoneda.getValue())) 
			JExcepcion.SendError("No se puede eliminar una relaci�n Moneda-Pa�s que participa en la configuracion de una forma de pago");
...
//		if (record==null) JExcepcion.SendError("No exite cotizaci�n");
