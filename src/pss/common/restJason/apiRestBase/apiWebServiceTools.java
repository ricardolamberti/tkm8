...
//		}
   ...
   public static JOrderedMap<String, String> getAnnotationsFrom(String dirName) throws Exception {
		...
		if (aFile == null)
			JExcepcion.SendError("El directorio^ '" + dirName + JLanguage.translate("' no existe, pero esta configurado en el producto. Se deber� eliminarlo de la confiuraci�n del producto."));
