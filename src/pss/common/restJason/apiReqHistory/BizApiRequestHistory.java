...
public class BizApiRequestHistory extends JRecord  {
  ...
  private JHtml pResponseHtml = new JHtml() {
	...
	public void createFixedProperties() throws Exception {
		...
		addFixedItem( FIELD, "method", "M�todo", true, true, 1000);
		addFixedItem( FIELD, "oper", "Operaci�n", true, false, 1);
		...
		addFixedItem( FIELD, "creation_date", "Fecha Creaci�n", true, true, 18);
