...
public class GuiBSPPersonas extends JWins {
   ...
   */
  public GuiBSPPersonas() throws Exception {
  }


  public int     GetNroIcono() throws Exception  { return 10032; } 
  public String  GetTitle()    throws Exception  { return "Clientes "; }
  public Class<? extends JWin>  GetClassWin()                   { return GuiBSPPersona.class; }
  /**
