...
public class GuiMailingPersonaTypeDetails extends JWins {
   ...
   */
  public GuiMailingPersonaTypeDetails() throws Exception {
  }


  public int     GetNroIcono() throws Exception  { return 10036; } 
  public String  GetTitle()    throws Exception  { return "Detalle"; }
  public Class<? extends JWin>  GetClassWin()                   { return GuiMailingPersonaTypeDetail.class; }
  /**
