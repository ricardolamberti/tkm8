  ...
  public static void ExecCheckForEvents() throws Exception {
  	...
  	try {
		...
		//	events.addFilter("tipo_periodicidad", BizSqlEventAction.LIMITE);
			...
			BizBspLog.log(BizUsuario.getUsr().getCompany(), "PRINCIPAL_"+BizUsuario.getUsr().getCompany(), BizBspLog.BSPLOG_MODULO_MENSAJERIA, BizBspLog.BSPLOG_ERROR , "Error envío "+ e.getMessage(), null, null, null, 0, 0, 0);
			e.printStackTrace();
		}
  }
