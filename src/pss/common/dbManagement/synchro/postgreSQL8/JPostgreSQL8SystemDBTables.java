 ...
 *
 */
public class JPostgreSQL8SystemDBTables extends JBaseSystemDBTables {

	/**
	 * @throws Exception
	 */
	public JPostgreSQL8SystemDBTables() throws Exception {
		super();
	...
	public Class<? extends JBaseSystemDBTable> getBasedClass() {
		return JPostgreSQL8SystemDBTable.class;
	}
