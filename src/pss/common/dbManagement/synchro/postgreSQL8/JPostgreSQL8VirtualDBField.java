 ...
 * 
 */
public class JPostgreSQL8VirtualDBField extends JBaseVirtualDBField {
	 ...
	 * @throws Exception
	 */
	public JPostgreSQL8VirtualDBField() throws Exception {
	...
	protected String generateDataTypeDescSQL() throws Exception {
		...
		// Proceso campo tipo unknown
		if (this.fieldGenericDataType.charAt(0) == JBaseVirtualDBField.C_TIPO_UNKNOWN) {
			// Description: variable-length with limit
			sql = "VARCHAR(" + this.fieldLength + ")";
			return sql;
		}		
