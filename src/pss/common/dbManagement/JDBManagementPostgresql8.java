...
public class JDBManagementPostgresql8 extends JBaseDBManagement {

  /**
   * Constructor
   */
  public JDBManagementPostgresql8() throws Exception {
   ...
   * Constructor
   */
  public JDBManagementPostgresql8(JBDato zBase) throws Exception {
