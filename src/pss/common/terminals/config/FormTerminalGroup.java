...
public class FormTerminalGroup extends JBaseForm {

  /**
   * Constructor de la Clase
   */
  public FormTerminalGroup() throws Exception {
  }

  public GuiTerminalGroup GetWin() { return (GuiTerminalGroup) getBaseWin(); }
  ...
  @Override
    ...
    panel.AddItemEdit("terminal_group", UINT, OPT, "terminal_group" ).hide();
    panel.AddItemCombo("Nodo", CHAR, REQ, "nodo", new JControlCombo() {
    	public JWins getRecords(boolean one) throws Exception {
    		return getNodos(one);
    	}
    }, 4);
    panel.AddItemEdit("Descripción", CHAR, REQ, "description",8 );
