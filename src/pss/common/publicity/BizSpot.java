...
public class BizSpot extends JRecord {
	 ...
	 */
	public BizSpot() throws Exception {
	}
	...
	public static JRecords<BizSpot> ReadCampaign(long zIdCampaign) throws Exception {
		JRecords<BizSpot> detalles=new JRecords<BizSpot>(BizSpot.class);
	...
	public static JRecords<BizSpot> ReadPage(long zIdCampaign, String zPage) throws Exception {
		JRecords<BizSpot> detalles=new JRecords<BizSpot>(BizSpot.class);
		detalles.addFilter("id", zIdCampaign);
