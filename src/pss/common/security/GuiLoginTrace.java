...
public class GuiLoginTrace extends JWin {
  ...
  @Override
	public String GetTitle()       throws Exception { return "Ingreso a la Aplicaci�n"; }
  @Override
...
//      msg = "Se cerrar�n todas las ventanas abiertas y se cargar� su perfil nuevamente. �Desea continuar?";
//    } else if (!newUser.equals("")) {
//      msg = "Se cerrar�n todas las ventanas abiertas y se cargar� el perfil para el usuario {"
...
//      int answer = UITools.MostrarYesNoMensaje("Cierre de sesión", "Se cerrar�n todas las ventanas abiertas. �Desea continuar?");
