...
public class GuiModuloCommon extends GuiModulo {
	...
	public BizAction createDynamicAction() throws Exception {
		return this.addAction(1, "Configuraci�n", null, 10035, true, true, true, "Group");
	}
	...
	public void createActionMap() throws Exception {
		...
		addAction(20, "Configuraci�n M�dulos", null, 1, true, false, true, "Group");
