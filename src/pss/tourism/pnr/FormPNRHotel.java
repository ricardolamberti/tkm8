...
public class FormPNRHotel extends JBaseForm {
    ...
    public void InicializarPanel(JWin zWin) throws Exception {
        ...
        row = AddItemRow();
        row.AddItemEdit("Pasajeros", UINT, OPT, "pasajeros").setSizeColumns(4);
        row.AddItemEdit("Habitaciones", UINT, OPT, "habitaciones").setSizeColumns(4);
        ...
        row.AddItemEdit("Hotel código", CHAR, OPT, "hotel_codigo").setSizeColumns(4);

        row = AddItemRow();
        row.AddItemDateTime("Fecha salida", DATE, OPT, "fecha_salida").setSizeColumns(4);
        row.AddItemEdit("Noches", UINT, OPT, "noches").setSizeColumns(4);
        row.AddItemEdit("Tour", CHAR, OPT, "tour_name").setSizeColumns(4);

        row = AddItemRow();
        row.AddItemEdit("Hotel", CHAR, OPT, "hotel_name").setSizeColumns(4);
