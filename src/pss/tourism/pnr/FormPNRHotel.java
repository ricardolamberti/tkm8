...
public class FormPNRHotel  extends JBaseForm {
...
private final JPanel panel = new JPanel();
   ...
   */
  public FormPNRHotel() throws Exception {
    try { jbInit(); }
  ...
  protected void jbInit() throws Exception {
    ...
    lpasajeros.setBounds(new Rectangle(138, 203, 63, 22)); 
    pasajeros.setBounds(new Rectangle(206, 203, 51, 22)); 
    add(lpasajeros, null);
    add(pasajeros , null);


    lhabitaciones.setText( "Habitaciones" );
    lhabitaciones.setBounds(new Rectangle(10, 228, 75, 22)); 
    habitaciones.setBounds(new Rectangle(84, 228, 51, 22)); 
    add(lhabitaciones, null);
    add(habitaciones , null);


    lcar_code.setText( "Tipo producto" );
    lcar_code.setBounds(new Rectangle(10, 255, 75, 22)); 
    car_code.setBounds(new Rectangle(84, 255, 143, 22)); 
    add(lcar_code, null);
    add(car_code , null);



    lhotel_codigo.setText( "Hotel codigo" );
    lhotel_codigo.setBounds(new Rectangle(10, 124, 123, 22)); 
    hotel_codigo.setBounds(new Rectangle(84, 124, 197, 22)); 
    add(lhotel_codigo, null);
    add(hotel_codigo , null);
    ...
    lnoches.setText( "Noches" );
    lnoches.setBounds(new Rectangle(10, 203, 123, 22)); 
    noches.setBounds(new Rectangle(84, 203, 51, 22)); 
    add(lnoches, null);
    add(noches , null);


    ltour_name.setText( "Tour name" );
    ltour_name.setBounds(new Rectangle(10, 177, 123, 22)); 
    tour_name.setBounds(new Rectangle(84, 177, 197, 22)); 
    add(ltour_name, null);
    add(tour_name , null);


    lhotel_name.setText( "Hotel name" );
    lhotel_name.setBounds(new Rectangle(10, 153, 123, 22)); 
    hotel_name.setBounds(new Rectangle(84, 153, 260, 22)); 
    add(lhotel_name, null);
    add(hotel_name , null);
    panel.setBorder(new TitledBorder(null, "Montos", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    panel.setBounds(364, 69, 283, 208);
    
    add(panel);
    panel.setLayout(null);
        limporte_base.setBounds(7, 16, 123, 22);
        panel.add(limporte_base);
    
    
        limporte_base.setText( "Importe base" );
        importe_base.setBounds(134, 16, 143, 22);
        panel.add(importe_base);
  ...
  public void InicializarPanel( JWin zWin ) throws Exception {
    ...
    AddItem( pasajeros, UINT, REQ, "pasajeros" );
    AddItem( habitaciones, UINT, REQ, "habitaciones" );
    AddItem( car_code, CHAR, REQ, "car_code" );
    AddItem( confirmacion, CHAR, REQ, "confirmacion" );
    AddItem( aeropuerto, CHAR, REQ, "aeropuerto" );
    AddItem( hotel_codigo, CHAR, REQ, "hotel_codigo" );
    AddItem( fecha_salida, DATE, REQ, "fecha_salida" );
    AddItem( noches, UINT, REQ, "noches" );
    AddItem( tour_name, CHAR, REQ, "tour_name" );
    AddItem( hotel_name, CHAR, REQ, "hotel_name" );
