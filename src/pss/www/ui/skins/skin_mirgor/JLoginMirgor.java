...
public class JLoginMirgor extends JWebView implements IActionPerform, ILoginPage {
...
//		l.setLanguageFromBrowser(language);
		...
		this.add("row",row);
		row.setBackgroundImage("skin/skin_mirgor/images/foto0.png");
...
//		row.setHeight(625);
		...
		imagen.setBackgroundImage("skin/skin_mirgor/images/logo-siti2.png");
	...
	public JWebActionResult perform(JAbstractLoginResolver loginResolver) throws Throwable {
		...
		if (captcha != null) {
			if (!sCaptcha.equals(JTools.PasswordToString(captcha)))
				throw new Exception(getMessage("Fallo verificaci�n contra bots"));
		}
