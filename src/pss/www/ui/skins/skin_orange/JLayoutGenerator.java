...
//		}
  ...
  public String getMessage(String zMsg, Object[] zParams)  {
  		if (zMsg.toLowerCase().length()>9 && zMsg.toLowerCase().substring(0, 9).equals("clave inv")) 
  			...
  			zMsg = "pref.skin";
   		else if (zMsg.equalsIgnoreCase("P�gina Inicial")) 
  			zMsg = "pref.paginitial";
   		else if (zMsg.equalsIgnoreCase("L�neas por p�g.")) 
  			zMsg = "pref.sizepage";
   		else if (zMsg.equalsIgnoreCase("Max.Reg.Matriz")) 
  			zMsg = "pref.maxreg";
   		else if (zMsg.equalsIgnoreCase("Usuario Inv�lido")) 
  			...
  			zMsg = "date.yesterday";
   		else if (zMsg.equalsIgnoreCase("Los �ltimos 7 d�as")) 
  			zMsg = "date.lastweek";
   		else if (zMsg.equalsIgnoreCase("Los �ltimos 30 d�as")) 
  			zMsg = "date.lastdays";
   		else if (zMsg.equalsIgnoreCase("Este mes")) 
  			zMsg = "date.month";
  		else if (zMsg.equalsIgnoreCase("Fecha inv�lida")) 
  			zMsg = "msg.invalid.date";
  		else if (zMsg.equalsIgnoreCase("Hora inv�lida")) 
  			zMsg = "msg.invalid.time";
  		else if (zMsg.equalsIgnoreCase("Anterior mes")) 
  			zMsg = "date.lastmonth";
   		else if (zMsg.equalsIgnoreCase("Este A�o")) 
  			zMsg = "date.year";
  		...
  		else if (zMsg.equalsIgnoreCase("Error de la aplicaci�n")) 
  			zMsg = "form.title.error";
