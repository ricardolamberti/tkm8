...
public class JWebInfoCardDoubleResponsive  extends JWebTextComponent  implements JWebActionable,JWebIconHolder,JWebLabelHolder {
  ...
  public JWebIcon getMaximizeIcon() {
	...
	public String getComponentType() {
		return "infocarddouble_responsive";
	}

	public static JWebInfoCardDoubleResponsive create(JWebViewComposite parent,  JFormInfoCardDoubleResponsive zEdit) throws Exception {
		JWebInfoCardDoubleResponsive webText=new JWebInfoCardDoubleResponsive();
	...
	protected void widgetToXML(JXMLContent zContent) throws Exception {
		...
		zContent.setAttribute("labelname_to", ((JFormTwoPropertiesResponsive)getControl()).getFixedPropTo().GetDescripcion());
		zContent.setAttribute("labelname_from", ((JFormTwoPropertiesResponsive)getControl()).getFixedPropFrom().GetDescripcion());
		zContent.setAttribute("prop_to", ((JFormTwoPropertiesResponsive)getControl()).getPropTo().toFormattedString());
		zContent.setAttribute("prop_from", ((JFormTwoPropertiesResponsive)getControl()).getPropFrom().toFormattedString());
