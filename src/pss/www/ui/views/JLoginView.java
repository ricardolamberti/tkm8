...
//			oPersistent.setMode(JFormCheckResponsive.MODE_SINGLE);
  ...
  private boolean isValidUser(String username, String password) {
	...
	private void analizeIniConfiguration() throws Exception {
		...
		loginRecovery = cfg.getCachedValue(secc, "LOGIN_RECUPERAR", "Olvid� su clave?");
		loginTitleLogo = cfg.getCachedValue(secc, "LOGIN_WELCOME_TITLE_LOGO", "15000");
		loginText = cfg.getCachedValue(secc, "LOGIN_WELCOME_TEXT", "Ud ha ingresado al �rea privada del SITI. Ingrese los datos de su usuario y presione 'confirmar' para comenzar a administrar su Empresa");
