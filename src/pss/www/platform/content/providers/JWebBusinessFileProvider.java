...
public class JWebBusinessFileProvider  extends ResourceReader {

	static String  outFolder;
	static String  outSitemapFolder;

	public static String getOutFolder() {
		return outFolder;
	}

	public static void setSitemapFolder(String outFolder) {
		JWebBusinessFileProvider.outSitemapFolder = outFolder;
	}

	public static String getSitemapFolder() {
		return outSitemapFolder;
	}

	public static void setOutFolder(String outFolder) {
		JWebBusinessFileProvider.outFolder = outFolder;
	}
	...
	public void setup(SourceResolver resolver, Map objectModel, String src, Parameters par) throws ProcessingException, SAXException, IOException {
		try {
			...
			String sFileName=getOutFolder()+"/"+src;
			HttpResponse resp = (HttpResponse)ObjectModelHelper.getResponse(objectModel);
			resp.setHeader("x-response-url", getSitemapFolder()+"/"+src);
