...
public class JSkinProvider extends ResourceReader {
	...
	public void setup(SourceResolver resolver, Map objectModel, String src, Parameters par) throws ProcessingException, SAXException, IOException {
		 String sRelativeSrc=JPath.normalizePath(src);//.replace("skin/",""); 
		 this.setLastModifiedHeader(ObjectModelHelper.getResponse(objectModel), sRelativeSrc);
		 super.setup(resolver, objectModel, JPath.PssPathResource()+"/www/ui/skins/"+sRelativeSrc, par);
	}

	private void setLastModifiedHeader(Response zResp, String zRelativeSrc) throws ProcessingException {
		try {
			String sPath=JPath.PssPathResource()+"/www/ui/skins/"+zRelativeSrc;
