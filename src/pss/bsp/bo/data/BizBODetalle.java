...
public class BizBODetalle extends JRecord {
  ...
  private JString pIdCliente = new JString();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void setIdCliente(String zValue) throws Exception {    pIdCliente.setValue(zValue);  }
  public String getIdCliente() throws Exception {     return pIdCliente.getValue();  }
  public boolean isNullIdCliente() throws Exception { return  pIdCliente.isNull(); } 
  public void setNullToIdCliente() throws Exception {  pIdCliente.setNull(); } 
   ...
   */
  public BizBODetalle() throws Exception {
  }
  ...
  public void createFixedProperties() throws Exception {
    ...
    this.addFixedItem( FIELD, "id_cliente", "id cliente", true, false, 50 );
    this.addFixedItem( FIELD, "cliente", "Cliente", true, false, 450 );
  }
  /**
   * Returns the table name
   */
  public String GetTable() { return "BSP_BO_DETALLE"; }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public void attachRelationMap(JRelations rels) throws Exception {
  	rels.setSourceWinsClass("pss.bsp.bo.data.GuiBODetalles");
  	JRelation rel; 
  	rel = rels.addRelationForce(10, "restriccion usuario");
   	rel.addFilter(" (BSP_BO_DETALLE.company is null or BSP_BO_DETALLE.company in (COMPANY_CUSTOMLIST)) ");
//  	rel.addJoin("BSP_BO_DETALLE.company", BizUsuario.getUsr().getCompany());
//  	rel.addJoin("BSP_PDF_ARG_DETALLE.owner", BizUsuario.getUsr().GetUsuario());
		...
		rel.addJoin("BSP_BO_DETALLE.company", "TUR_PNR_BOLETO.company");
		rel.addJoin("BSP_BO_DETALLE.boleto", "TUR_PNR_BOLETO.NumeroBoleto");
