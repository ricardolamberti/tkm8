...
public class FormBODetalle extends JBaseForm {
    ...
    public void InicializarPanel(JWin zWin) throws Exception {
        AddItemRow().AddItemEdit("Company", CHAR, REQ, "company").setHide(true);
        AddItemRow().AddItemEdit("Owner", CHAR, REQ, "owner").setHide(true);
        AddItemRow().AddItemEdit("Idinterfaz", UINT, REQ, "idInterfaz").setHide(true);
        AddItemRow().AddItemEdit("Linea", UINT, REQ, "linea").setHide(true);
