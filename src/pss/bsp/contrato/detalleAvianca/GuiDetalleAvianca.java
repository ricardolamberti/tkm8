...
import pss.bsp.contrato.detalleCopa.FormDetalleCopa;
import pss.bsp.contrato.detalleCopa.FormEditDetalleCopa;
...
public class GuiDetalleAvianca extends GuiDetalle {
   ...
   */
  public GuiDetalleAvianca() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleAvianca(); }
  public int GetNroIcono()   throws Exception { return 15011; }
  public String getTitle()   throws Exception { return "Objetivo Avianca"; }
  public Class<? extends JBaseForm> getFormBase() throws Exception { 
  	if (GetVision().equals("VIEW" ))
 		 return FormEditDetalleAvianca.class;
  	return FormDetalleAvianca.class; 
  }
  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleAvianca.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleAvianca.class; }
  ...
  public BizDetalleAvianca GetccDato() throws Exception { return (BizDetalleAvianca) this.getRecord(); }
