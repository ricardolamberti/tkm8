...
public class FormObjetivosGrilla extends JBaseForm {
...
private JPssLabel lvariacion1 = null;
   ...
   */
  public FormObjetivosGrilla() throws Exception {
    try { jbInit(); }
    catch (Exception e) { e.printStackTrace(); } 
  }

  public GuiObjetivosGrilla getWin() { return (GuiObjetivosGrilla) getBaseWin(); }
