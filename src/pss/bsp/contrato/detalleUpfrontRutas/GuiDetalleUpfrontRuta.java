...
public class GuiDetalleUpfrontRuta extends GuiDetalle {

	/**
	 * Constructor de la Clase
	 */
	public GuiDetalleUpfrontRuta() throws Exception {
	}
	...
	public Class<? extends JBaseForm> getFormBase() throws Exception {
		if (GetVision().equals("VIEW"))
			return FormEditDetalleUpfrontRuta.class;
		return FormDetalleUpfrontRuta.class;
	}
	...
	public BizDetalleUpfrontRuta GetccDato() throws Exception {
		return (BizDetalleUpfrontRuta) this.getRecord();
	}

	@Override
	public Class<? extends JBaseForm> getFormFlat() throws Exception {
		return FormDetalleUpfrontRutaFlat.class;
	}
