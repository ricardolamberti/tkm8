...
public class FormDetalleDatamining extends JBaseForm {
...
/**
   ...
   */
  public FormDetalleDatamining() throws Exception {
    try { jbInit(); }
    catch (Exception e) { e.printStackTrace(); } 
  }

  public GuiDetalleDatamining getWin() { return (GuiDetalleDatamining) getBaseWin(); }
...
//    AddItem( getJComboBox(), CHAR, OPT, "periodo" , JWins.createVirtualWinsFromMap(BizDetalleDatamining.getPeriodos()));
