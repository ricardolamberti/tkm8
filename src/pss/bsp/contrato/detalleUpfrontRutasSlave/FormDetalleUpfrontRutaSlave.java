...
public class FormDetalleUpfrontRutaSlave extends JBaseForm {
	 ...
	 */
	public FormDetalleUpfrontRutaSlave() throws Exception {
		try {
			jbInit();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public GuiDetalleUpfrontRutaSlave getWin() {
		return (GuiDetalleUpfrontRutaSlave) getBaseWin();
	}
    ...
    panelM.AddItemEdit( "Aerolineas", CHAR, OPT, "aerolineas" ).setSizeColumns(4).setReadOnly(true);;
    ...
    panelM.AddItemThreeCheck( "Tipo", CHAR, OPT, "domestic" , "S",JFormRadioResponsive.NO_FILTER,"N","Doméstico","-","Internacional").setSizeColumns(6).SetReadOnly(true);
    panelM.AddItemThreeCheck( "Interlineal", CHAR, OPT,"interlineal" , "S",JFormRadioResponsive.NO_FILTER,"N","Multiples aerolíneas","-","Solo una").setSizeColumns(3).SetReadOnly(true);
    panelM.AddItemEdit( "Premio",FLOAT,REQ, "premio_upfront").setSizeColumns(3).SetReadOnly(true);
    
		
		JFormFieldsetResponsive panelR = column2.AddItemFieldset("Resultados", 12);
		...
		panelR.AddItemEdit("Valor Base comisionable", FLOAT, OPT, "valor_totalcontrato_calc").setSizeColumns(6).setVisible(true).SetReadOnly(true);
		// panelR.AddItemEdit( "Nivel alcanzado", CHAR, OPT,
		// "nivel_alcanzado_estimada" ).setSizeColumns(6).SetReadOnly(true);
		panelR.AddItemEdit("Ganancia/Comisión", FLOAT, OPT, "ganancia_estimada_calc").setSizeColumns(6).SetReadOnly(true);
...
//		i.setHeight(480);
		...
		JFormFieldsetResponsive panelI = column2.AddItemFieldset("Contrato", 6);
