...
import pss.bsp.contrato.detalle.FormEditDetalle;
...
public class GuiDetalleUpfrontRutaSlave extends GuiDetalle {

	/**
	 * Constructor de la Clase
	 */
	public GuiDetalleUpfrontRutaSlave() throws Exception {
	}

	public JRecord ObtenerDato() throws Exception {
		return new BizDetalleUpfrontRutaSlave();
	}
	...
	public String getTitle() throws Exception {
		return "Objetivo Upfront Ruta";
	}

	public Class<? extends JBaseForm> getFormBase() throws Exception {
		if (GetVision().equals("VIEW"))
			return FormEditDetalleUpfrontRutaSlave.class;
		return FormDetalleUpfrontRutaSlave.class;
	}
	...
	public String getDescripField() {
		return "variable_ganancia";
	}

	public BizDetalle GetcDato() throws Exception {
		return (BizDetalle) this.getRecord();
	}

	public BizDetalleUpfrontRutaSlave GetccDato() throws Exception {
		return (BizDetalleUpfrontRutaSlave) this.getRecord();
	}

	@Override
	public Class<? extends JBaseForm> getFormFlat() throws Exception {
		return FormDetalleUpfrontRutaFlatSlave.class;
	}
