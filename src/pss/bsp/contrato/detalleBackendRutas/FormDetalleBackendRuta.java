...
public class FormDetalleBackendRuta extends JBaseForm {
...
/**
   ...
   */
  public FormDetalleBackendRuta() throws Exception {
    try { jbInit(); }
  ...
  public void InicializarPanel( JWin zWin ) throws Exception {
    ...
    JFormLocalForm tab2 = tabsI.AddItemLocalForm("Base Comisionable");
    ...
    i=panelG2.AddItemImage("", "imagen4" );
    i.setHeight(680);
    i.setSource(JPssImage.SOURCE_SCRIPT);
    i.setSizeColumns(10);
