...
public class GuiDetalleBackendRuta extends GuiDetalle {
   ...
   */
  public GuiDetalleBackendRuta() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleBackendRuta(); }
  ...
  public Class<? extends JBaseForm> getFormBase() throws Exception {
  	if (GetVision().equals("VIEW" ))
  		 return FormEditDetalleBackendRuta.class;
  	return FormDetalleBackendRuta.class; 
  }
  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleBackendRuta.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleBackendRuta.class; }
  ...
  public BizDetalleBackendRuta GetccDato() throws Exception { return (BizDetalleBackendRuta) this.getRecord(); }
