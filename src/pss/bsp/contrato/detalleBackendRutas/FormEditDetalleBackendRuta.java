...
public class FormEditDetalleBackendRuta extends JBaseForm {
	...
	/**
	   ...
	   */
	  public FormEditDetalleBackendRuta() throws Exception {
	    try { jbInit(); }
	    catch (Exception e) { e.printStackTrace(); } 
	  }

	  public GuiDetalleBackendRuta getWin() { return (GuiDetalleBackendRuta) getBaseWin(); }
...
//		  objetivo.AddItemCheck( "Omitir exchange", CHAR, "exchange" ).setSizeColumns(4);
    ...
    JFormFieldsetResponsive col3 = (JFormFieldsetResponsive) base.AddItemFieldset("Origen").setSizeColumns(6);
	    ...
	    JFormFieldsetResponsive col4 = (JFormFieldsetResponsive) base.AddItemFieldset("Destino").setSizeColumns(6);
		  ...
		  base.AddItemCheck( "Bookings", CHAR, "pax_base" ).setSizeColumns(4);
		  base.AddItemThreeCheck( "Fecha", CHAR, OPT, "volado_base" , "S",JFormRadioResponsive.NO_FILTER,"N","Volado","Volado y emitido","Emitido").setSizeColumns(4);
