...
public class BizDetalleUpfront extends BizDetalleDatamining {
	...
	public String getImagen1(boolean printerVersion) throws Exception {
  	...
  	if (getObjEventGanancia()==null) return null;
   	if (!getObjEventGanancia().isOK()) return "<div class=\"panel panel-default\" style=\"height: 100%;width: 100%; text-align: center;\"><b>Aguardando recalculo del indicador.<br/>Estado actual: "+getObjEventGanancia().getEstado()+"</b></div>";
...
//		gr.setColorMax("#00ff00");
	...
	public String getImagen2() throws Exception {     
  	...
  	Calendar fd = Calendar.getInstance();
		...
		fh.setTime(hasFechaCalculo()?getFechaCalculo():hasFechaCalculo()?getFechaCalculo():getObjContrato().getFechaHasta());
...
//		}
		...
		gr.setTitle("VENTA DE "+getObjEvent().getDescripcion().toUpperCase()+" A HOY");
		gr.setLeyenda(""+gr.getValor());
		return gr.getImage(300, 300).replace("script:", "");
	}
	
	public BizDetalleUpfront() throws Exception {
		super();
	...
	public void processInsert() throws Exception {
		setLogicaContrato(JContratoUpfront.class.getName());
		super.processInsert();
	}
  ...
  public  void processMercado() throws Exception {
  	...
  	if (!getObjEventGanancia().getClassDetalle().equals(GuiPNRTickets.class.getName())) return;
