...
public class GuiDetalleUpfront extends GuiDetalleDatamining {
   ...
   */
  public GuiDetalleUpfront() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleUpfront(); }
  public int GetNroIcono()   throws Exception { return 15011; }
  public String getTitle()   throws Exception { return "Objetivo upfront"; }
  public Class<? extends JBaseForm> getFormBase() throws Exception { 
  	if (GetVision().equals("VIEW" ))
 		 return FormEditDetalleUpfront.class;
  	return FormDetalleUpfront.class; 
  }
  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleUpfront.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleUpfront.class; }
  ...
  public BizDetalleUpfront GetccDato() throws Exception { return (BizDetalleUpfront) this.getRecord(); }

 
  @Override
  public Class<? extends JBaseForm> getFormFlat() throws Exception {
  	return FormDetalleUpfrontFlat.class;
  }
