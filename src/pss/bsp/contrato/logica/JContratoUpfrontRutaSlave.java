...
import pss.bsp.contrato.detalleUpfrontRutasSlave.BizDetalleUpfrontRutaSlave;
import pss.bsp.contrato.detalleUpfrontRutasSlave.GuiDetalleUpfrontRutaSlave;

public class JContratoUpfrontRutaSlave  implements ILogicaContrato {
	//
//@Override
...
public GuiDetalle getWin() throws Exception {
	return new GuiDetalleUpfrontRutaSlave();
}
