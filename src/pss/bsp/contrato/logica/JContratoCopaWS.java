...
import pss.bsp.contrato.detalleCopaWS.BizDetalleCopaWS;
import pss.bsp.contrato.detalleCopaWS.GuiDetalleCopaWS;

public class JContratoCopaWS implements ILogicaContrato {
...
public GuiDetalle getWin() throws Exception {
	return new GuiDetalleCopaWS();
}

@Override
public BizDetalle getBiz() throws Exception {
	return new BizDetalleCopaWS();
}
