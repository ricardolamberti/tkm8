...
public class FormDetalleDataminingTri extends JBaseForm {
...
/**
   ...
   */
  public FormDetalleDataminingTri() throws Exception {
    try { jbInit(); }
...
//    AddItem( getJComboBox(), CHAR, OPT, "periodo" , JWins.createVirtualWinsFromMap(BizDetalleDataminingTri.getPeriodos())).SetReadOnly(true);;
...
//    AddItem( textField_1, DATE, OPT, "fecha_calculo" ).SetValorDefault(getWin().GetcDato().getObjContrato().getFechaHasta()).setRefreshForm(true);
//
//    
