...
import pss.bsp.contrato.detalleLatamFamilia.FormDetalleDataminingTriFamilia;
import pss.bsp.contrato.detalleLatamFamilia.FormEditDetalleDataminingTriFamilia;
...
public class GuiDetalleDataminingTri extends GuiDetalle {
   ...
   */
  public GuiDetalleDataminingTri() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleDataminingTri(); }
  ...
  public Class<? extends JBaseForm> getFormBase() throws Exception { 
  	if (GetVision().equals("VIEW" ))
 		 return FormEditDetalleDataminingTri.class;
  	return FormDetalleDataminingTri.class; 
  }

  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleDataminingTri.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleDataminingTri.class; }
  ...
  public BizDetalleDataminingTri GetccDato() throws Exception { return (BizDetalleDataminingTri) this.getRecord(); }
