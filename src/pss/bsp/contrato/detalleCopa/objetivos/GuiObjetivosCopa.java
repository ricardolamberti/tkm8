...
public class GuiObjetivosCopa extends JWin {
   ...
   */
  public GuiObjetivosCopa() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizObjetivosCopa(); }
  public int GetNroIcono()   throws Exception { return 15011; }
  public String GetTitle()   throws Exception { return "Objetivo COPA"; }
  public Class<? extends JBaseForm> getFormBase() throws Exception { return FormObjetivosCopa.class; }
  public String  getKeyField() throws Exception { return "id"; }
  public String  getDescripField() { return "descripcion"; }
  public BizObjetivosCopa GetcDato() throws Exception { return (BizObjetivosCopa) this.getRecord(); }
