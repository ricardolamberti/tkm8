...
public class BizWizardContratoUpfront  extends JRecord {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public BizDetalle getDetalle() throws Exception {     
  	...
  	BizDetalleUpfrontRuta det = new BizDetalleUpfrontRuta();
   ...
   */
  public BizWizardContratoUpfront() throws Exception {
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public BizContrato getObjContrato() throws Exception {
	...
	public BizDetalle execGenerarContrato() throws Exception {
		JExec oExec = new JExec(null, "processGenerarContrato") {

			@Override
			public void Do() throws Exception {
				setOutput(processGenerarContrato());
			}
		};
		oExec.execute();
		return (BizDetalle)oExec.getOutput();
	}
	...
	public BizDetalle processGenerarContrato() throws Exception {
		BizDetalleUpfrontRuta last=null;
