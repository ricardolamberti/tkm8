...
import pss.bsp.contrato.detalleDatamining.FormDetalleDatamining;
import pss.bsp.contrato.detalleDatamining.FormEditDetalleDatamining;
...
public class GuiDetalleRuta extends GuiDetalle {
   ...
   */
  public GuiDetalleRuta() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleRuta(); }
  ...
  public Class<? extends JBaseForm> getFormBase() throws Exception { 
  	if (GetVision().equals("VIEW" ))
 		 return FormEditDetalleRuta.class;
  	return FormDetalleRuta.class; 
  }
  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleRuta.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleRuta.class; }
  ...
  public BizDetalleRuta GetccDato() throws Exception { return (BizDetalleRuta) this.getRecord(); }
