...
public class BizWizardContratoBackend  extends JRecord {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void setDetalle(BizDetalle det) throws Exception { 
  	objDetalle = det;
  }
  public BizDetalle buildDetalle(GuiDetalle win) throws Exception {     
  	if (objDetalle!=null) return (BizDetalle)objDetalle;
  	BizDetalle det = win.GetcDato();
   ...
   */
  public BizWizardContratoBackend() throws Exception {
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public BizContrato getObjContrato() throws Exception {
	...
	public JRecords<BizContrato> getContratosCandidatos() throws Exception {
  	...
  	eventsSearch.addFilter("tipo_contrato", "C");
  	eventsSearch.addFilter("descripcion", getObjCarrier().getDescription().toUpperCase(), "like");
  	if (getFechaDesde()==null) {
	...
	public BizContrato processGenerarContrato(BizDetalle rec) throws Exception {
		...
		while (it.hasMoreElements()) {
			...
			if (contrato.getDescripcion().equals("Nuevo Contrato")) {
					...
					contrato.setDescripcion(getObjCarrier().getDescription().toUpperCase()+" "+getPeriodo());
					contrato.setFechaDesde(contrato.getFechaDesde());
					contrato.setFechaHasta(contrato.getFechaHasta());
					contrato.setTipoContrato("C");
  ...
  JRecords<BizContratoConocidoV2> getModelosContratosCandidatos() throws Exception {
  	JRecords<BizContratoConocidoV2> contratos= new JRecords<BizContratoConocidoV2>(BizContratoConocidoV2.class);
//  	contratos.addFilter("periodo", getPeriodo());
//  	contratos.addFilter("aerolineas", getAerolineas(), "like");
  	return contratos;
  }
