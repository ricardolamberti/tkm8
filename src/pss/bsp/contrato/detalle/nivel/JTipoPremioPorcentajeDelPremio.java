...
public class JTipoPremioPorcentajeDelPremio   extends JTipoPremio  implements ITipoPremio {
	public double calcule(double total, double level, BizNivel nivel, BizDetalle detalle) throws Exception {
  	...
  	niveles.addOrderBy("valor","ASC");
		...
		if  (nivel.getParam4()!=0)
			porcentaje = (porcentaje*nivel.getParam4())/100;
