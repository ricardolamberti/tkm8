...
public class JTipoPremioNivelSobreTotalPorFamilia  extends JTipoPremio  implements ITipoPremio {
	public double calcule(double total, double level, BizNivel nivel, BizDetalle detalle) throws Exception {
		double poderado=detalle.getPonderado();
		BizNivel n=null;
  	...
  	niveles.addOrderBy("valor","ASC");
		...
		return JTools.rd(total * ((porcentaje*poderado/100)/100.0),2);
