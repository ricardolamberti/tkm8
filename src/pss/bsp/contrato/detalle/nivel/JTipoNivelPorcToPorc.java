...
public class JTipoNivelPorcToPorc  extends JTipoNivel implements ITipoNivel {
  ...
  public boolean needValorRefGLobal() throws Exception {
	...
	public String getError(BizNivel nivel) throws Exception {
		if (nivel.getObjDetalle().getValorGlobal()==0) return "Debe proveerse un valor global con el share objetivo";
