...
public class JTipoNivelNormalConLimite  extends JTipoNivel implements ITipoNivel  {

	public double calcule(BizNivel nivel) throws Exception {
		if (nivel.getRealValor()<nivel.getParam2()) return 0;
	...
	public String getError(BizNivel nivel) throws Exception {
		if (nivel.getRealValor()<nivel.getParam2()) return "No se alcanzo el minimo de "+nivel.getParam2();
