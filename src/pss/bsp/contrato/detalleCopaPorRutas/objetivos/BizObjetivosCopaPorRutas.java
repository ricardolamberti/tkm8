...
public class BizObjetivosCopaPorRutas  extends JRecord {
  ...
  public JCurrency pCantidad = new JCurrency();
  public JLong pFaltante = new JLong();
  public JCurrency pTotal = new JCurrency();
  ...
  public JHtml pLabelZonas = new JHtml();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public BizObjetivosCopaPorRutas() throws Exception {
  }
  ...
  public void createFixedProperties() throws Exception {
    ...
    this.addFixedItem( FIELD, "cantidad", "Cantidad $", true, true, 18 ,2);
    ...
    this.addFixedItem( FIELD, "total", "Total $", true, true, 18 ,2);
    ...
    this.addFixedItem( FIELD, "ingreso", "Premio", true, true, 18,2 );
