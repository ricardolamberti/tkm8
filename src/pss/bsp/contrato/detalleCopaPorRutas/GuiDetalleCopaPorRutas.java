...
public class GuiDetalleCopaPorRutas  extends GuiDetalle {
   ...
   */
  public GuiDetalleCopaPorRutas() throws Exception {
  }


  public JRecord ObtenerDato()   throws Exception { return new BizDetalleCopaPorRutas(); }
  ...
  public Class<? extends JBaseForm> getFormBase() throws Exception { 
  	if (GetVision().equals("VIEW" ))
 		 return FormEditDetalleCopaPorRutas.class;
  	return FormDetalleCopaPorRutas.class; 
  }
  public Class<? extends JBaseForm> getFormNew() throws Exception { return FormEditDetalleCopaPorRutas.class; }
  public Class<? extends JBaseForm> getFormUpdate() throws Exception { return FormEditDetalleCopaPorRutas.class; }
  ...
  public BizDetalleCopaPorRutas GetccDato() throws Exception { return (BizDetalleCopaPorRutas) this.getRecord(); }
