...
public class GuiDQBs extends JWins {
   ...
   */
  public GuiDQBs() throws Exception {
  }


  public int     GetNroIcono() throws Exception  { return 10056; } 
  public String  GetTitle()    throws Exception  { return "Interface DQBs"; }
  public Class<? extends JWin>  GetClassWin()                   { return GuiDQB.class; }
  /**
