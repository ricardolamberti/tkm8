...
public class GuiMitConciliacion extends JWin {
  ...
  //-------------------------------------------------------------------------//
  public GuiMitConciliacion() throws Exception {
  }

  @Override
	public JRecord ObtenerDato()       throws Exception { return new BizMitConciliacion(); }
  @Override
	public int GetNroIcono()       throws Exception { return 5052; }
  @Override
	public String GetTitle()       throws Exception { return "Mit detalle"; }
  @Override
	public Class<? extends JBaseForm> getFormBase()     throws Exception { return FormMitConciliacion.class; }
   @Override
...
//	}
  ...
  //-------------------------------------------------------------------------//
  public BizMitConciliacion GetcDato() throws Exception {
    return (BizMitConciliacion) this.getRecord();
  }
