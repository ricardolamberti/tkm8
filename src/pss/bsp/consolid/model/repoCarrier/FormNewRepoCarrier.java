...
public class FormNewRepoCarrier extends JBaseForm {

	
	// -------------------------------------------------------------------------//
	// Constructor de la Clase
	// -------------------------------------------------------------------------//
	public FormNewRepoCarrier() throws Exception {

	}

	public GuiRepoCarrier GetWin() {
		return (GuiRepoCarrier) GetBaseWin();
	}
