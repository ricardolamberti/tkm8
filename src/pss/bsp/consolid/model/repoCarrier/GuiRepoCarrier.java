...
public class GuiRepoCarrier extends JWin {
  ...
  //-------------------------------------------------------------------------//
  public GuiRepoCarrier() throws Exception {
  }

  @Override
	public JRecord ObtenerDato()       throws Exception { return new BizRepoCarrier(); }
  @Override
	public int GetNroIcono()       throws Exception { return 5052; }
  @Override
	public String GetTitle()       throws Exception { return "Análisis Aerolínea"; }
  @Override
	public Class<? extends JBaseForm> getFormBase()     throws Exception { return FormRepoCarrier.class; }
  @Override
	public Class<? extends JBaseForm> getFormNew()     throws Exception { return FormNewRepoCarrier.class; }
  @Override
  ...
  //-------------------------------------------------------------------------//
  public BizRepoCarrier GetcDato() throws Exception {
    return (BizRepoCarrier) this.getRecord();
  }

  public JWins getDetailrepoCarrier() throws Exception {
  	JRecords<BizRepoCarrierDetail> dets = new JRecords<BizRepoCarrierDetail>(BizRepoCarrierDetail.class);
  	dets.addFilter("repo_dk_id", GetcDato().getId());
  	dets.setParent(this.GetcDato());
  	dets.addFilter("company", GetcDato().getCompany());
  	dets.addOrderBy("carrier","ASC");
  	dets.SetVision(""+ GetcDato().getId());
  	GuiRepoCarrierDetails gui = new GuiRepoCarrierDetails();
  	gui.setRecords(dets);
  	return gui;
  }
