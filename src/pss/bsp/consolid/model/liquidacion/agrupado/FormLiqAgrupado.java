...
public class FormLiqAgrupado extends JBaseForm {
	 ...
	 */
	public FormLiqAgrupado() throws Exception {
	}

	public GuiLiqAgrupado getWin() {
		return (GuiLiqAgrupado) getBaseWin();
	}
    ...
    row.AddImageCard("Exportar", JWebIcon.getResponsiveIcon("fa fa-file-excel fa-3x"), "Emitir en EXCEL", 30).setSizeColumns(3);
		...
		AddItemEdit("Grupo DK", CHAR, OPT, "grupo_dk").setSizeColumns(2).setReadOnly(true);
