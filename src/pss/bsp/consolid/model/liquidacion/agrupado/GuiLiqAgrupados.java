...
public class GuiLiqAgrupados extends JWins {

	/**
	 * Constructor de la Clase
	 */
	public GuiLiqAgrupados() throws Exception {
	}
	...
	public void ConfigurarColumnasLista(JWinList zLista) throws Exception {
		...
		if (!GetVision().equals("DK_ADMIN")) {
			if (!BizBSPCompany.getObjBSPCompany(BizUsuario.getUsr().getCompany()).isDependant()) {
				...
				zLista.AddColumnaLista("grupo_descr");
...
//					};
	...
	public String exportarAExcel() throws Exception {
		...
		JRecords<BizLiqAgrupado> recs = new JRecords<BizLiqAgrupado>(BizLiqAgrupado.class);
		...
		JIterator<BizLiqAgrupado> it = recs.getStaticIterator();
		String[] files = new String[recs.getStaticItems().size()];
		while (it.hasMoreElements()) {
			BizLiqAgrupado liq = it.nextElement();
			JBDReportes report = (JBDReportes) liq.createDataSource().getRecord();
			String fileName = BizUsuario.getUsr().getCompany() + "/" + liq.getGrupoDK() + "_" + report.toString() + ".pdf";
...
//			JBDReportes report = (JBDReportes) liq.createDataSource().getRecord();
//
//			String fileName = company + "/" + liq.getDK() + "_" + company + "_" + liqdesde + "_" + liqhasta + "_" + report.toString() + ".pdf";
...
//	}
	...
	public void ConfigurarFiltros(JFormFiltro zFiltros) throws Exception {
		if (!BizBSPCompany.getObjBSPCompany(BizUsuario.getUsr().getCompany()).isDependant()) {
			zFiltros.addEditResponsive("Grupo DK", "grupo_dk").setOperator("=");
