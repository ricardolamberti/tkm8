...
public class BizLiqAcum extends JRecord {
	...
	private JString pDkCode = new JString();
	...
	private JFloat pTotalTax = new JFloat();
	...
	public void setDKCode(String zValue) throws Exception { pDkCode.setValue(zValue); }
	public String getDKCode() throws Exception { return pDkCode.getValue(); }
	...
	public void setTotalTax(double zValue) throws Exception { pTotalTax.setValue(zValue); }
	public double getTotalTax() throws Exception { return pTotalTax.getValue(); }
	 ...
	 */
	public BizLiqAcum() throws Exception {
	}
	...
	//	this.addItem("fecha_liquidacion", pFechaLiquidacion);
		...
		this.addItem("total_tax", pTotalTax);
    ...
    this.addFixedItem(FIELD, "organization", "Organización", true, false, 50);
		...
		this.addFixedItem(FIELD, "dk_code", "DK ref", true, false, 30);
		...
		this.addFixedItem(FIELD, "total_tax", "Total Tax", true, false, 19, 2);
   ...
   */
  public String GetTable() { return "bsp_liquidation_acum"; }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public boolean readById( long zId ) throws Exception { 
    addFilter( "id",  zId ); 
    return read(); 
  } 
  ...
  public BizClienteDK getObjMailing() throws Exception {
  ...
  public BizOrganization getObjOrganization() throws Exception {
	...
	public String procMarcar() throws Exception {
		setPendiente(true);
		processUpdate();
		BizClienteDK objMail=getObjMailing();
  ...
  public BizSqlEventAction getSqlEventAction() throws Exception {
  	BizSqlEventAction sql = new BizSqlEventAction();
		...
		sql.addFilter("class_evento", BizLiqAcum.class.getCanonicalName());
	...
	public void sendMail() throws Exception {
		BizClienteDK pers = new BizClienteDK();
		pers = new BizClienteDK();
		pers.dontThrowException(true);
		if (!pers.ReadByDK( getCompany() , getDK())) return;
