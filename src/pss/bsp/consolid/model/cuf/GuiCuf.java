...
public class GuiCuf extends JWin {
  ...
  //-------------------------------------------------------------------------//
  public GuiCuf() throws Exception {
  }

  @Override
	public JRecord ObtenerDato()       throws Exception { return new BizCuf(); }
  @Override
	public int GetNroIcono()       throws Exception { return 5052; }
  @Override
	public String GetTitle()       throws Exception { return "CUF"; }
  @Override
	public Class<? extends JBaseForm> getFormBase()     throws Exception { return FormCuf.class; }
  @Override
	public Class<? extends JBaseForm> getFormNew()     throws Exception { return FormNewCuf.class; }
  @Override
  ...
  public void createActionMap() throws Exception {
  	this.addAction(10, "CUF", null, 10020, false, false, false, "Group");		
  ...
  //-------------------------------------------------------------------------//
  public BizCuf GetcDato() throws Exception {
    return (BizCuf) this.getRecord();
  }

  public JWins getDetailCuf() throws Exception {
  	GuiCufDetails dets = new GuiCufDetails();
  	dets.getRecords().addFilter("company", GetcDato().getCompany());
  	dets.getRecords().addFilter("id_cuf", GetcDato().getId());
  	return dets;
  }
