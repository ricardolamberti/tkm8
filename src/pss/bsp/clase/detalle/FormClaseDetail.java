...
/**
   ...
   */
  public FormClaseDetail() throws Exception {
    try { jbInit(); }
    catch (Exception e) { e.printStackTrace(); } 
  }

  public GuiClaseDetail getWin() { return (GuiClaseDetail) getBaseWin(); }
...
//    lpais1111.setText("el sistema tomar� el de prioridad mas alta");
...
//    AddItem( idClase, CHAR, OPT, "id_clase" );
