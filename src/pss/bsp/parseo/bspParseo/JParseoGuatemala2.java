...
import pss.bsp.pdf.gua.cabecera.GuiGuaCabecera;
import pss.bsp.pdf.gua.detalle.BizGuaDetalle;
import pss.bsp.pdf.gua.detalle.GuiGuaDetalles;
import pss.bsp.pdf.gua.impuesto.BizGuaImpuesto;
import pss.bsp.pdf.gua.impuesto.GuiGuaImpuestos;
import pss.bsp.pdf.gua2.IFinderGua2;
import pss.bsp.pdf.gua2.JParseoGua2;
import pss.core.services.records.JRecords;
import pss.core.tools.collections.JIterator;
import pss.core.win.JWin;
import pss.core.win.JWins;

public class JParseoGuatemala2  extends JParseoGua2 implements IFinderGua2, IBspSititaParser {

	
	public JParseoGuatemala2() {
...
//		JBDatos.GetBases().commit();	
	...
	public JWin getGuiHeader(String zCompany, String zOwner, String zIdPdf) throws Exception {
		GuiGuaCabecera cabecera = new GuiGuaCabecera();
...
//		cabecera.GetcDato().addFilter("owner", zOwner);
	...
	public JWins getGuisDetail(String zCompany, String zOwner, String zIdPdf) throws Exception {
		GuiGuaDetalles detalle = new GuiGuaDetalles();
...
//		detalle.getRecords().addFilter("owner", zOwner);
		...
		GuiGuaImpuestos impuestos = new GuiGuaImpuestos();
...
//		impuestos.getRecords().addFilter("owner", zOwner);
	...
	public boolean fillFormat(BizPDF pdfBase,String[][] learningBase,BizFormato formato) throws Exception {
	  JRecords<BizGuaDetalle> details = new JRecords<BizGuaDetalle>(BizGuaDetalle.class);
...
//	  details.addFilter("owner", pdfBase.getOwner());
	  ...
	  JIterator<BizGuaDetalle> it = details.getStaticIterator();
	  int cant=0;
	  ...
	  while (it.hasMoreElements()) {
	  	BizGuaDetalle detail = it.nextElement();
