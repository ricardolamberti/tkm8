...
import pss.bsp.pdf.mex.IFinderMex;
import pss.bsp.pdf.mex.JParseoMex;
...
public class JParseoMexico extends JParseoMex implements IFinderMex, IBspSititaParser {

	
	public JParseoMexico() {
