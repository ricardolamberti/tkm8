...
import pss.bsp.pdf.chl.IFinderChile;
import pss.bsp.pdf.chl.JParserChile;
import pss.bsp.pdf.chl.cabecera.BizChileCabecera;
import pss.bsp.pdf.chl.cabecera.GuiChileCabecera;
import pss.bsp.pdf.chl.detalle.BizChileDetalle;
import pss.bsp.pdf.chl.detalle.GuiChileDetalles;
...
import pss.core.win.JWins;
	...
	public class JParseoChile extends JParserChile implements IFinderChile, IBspSititaParser {
...
//			JBDatos.GetBases().commit();	
		...
		public JWin getGuiHeader(String zCompany, String zOwner, String zIdPdf) throws Exception {
			GuiChileCabecera cabecera = new GuiChileCabecera();
...
//			cabecera.GetcDato().addFilter("owner", zOwner);
		...
		public JWins getGuisDetail(String zCompany, String zOwner, String zIdPdf) throws Exception {
			GuiChileDetalles detalle = new GuiChileDetalles();
...
//			detalle.getRecords().addFilter("owner", zOwner);
			...
			GuiChileImpuestos impuestos = new GuiChileImpuestos();
...
//			impuestos.getRecords().addFilter("owner", zOwner);
		...
		public boolean fillFormat(BizPDF pdfBase,String[][] learningBase,BizFormato formato) throws Exception {
		  JRecords<BizChileDetalle> details = new JRecords<BizChileDetalle>(BizChileDetalle.class);
...
//		  details.addFilter("owner", pdfBase.getOwner());
		  ...
		  JIterator<BizChileDetalle> it = details.getStaticIterator();
		  int cant=0;
		  ...
		  while (it.hasMoreElements()) {
		  	BizChileDetalle detail = it.nextElement();
