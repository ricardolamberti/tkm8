...
import pss.bsp.pdf.gua.IFinderGua;
import pss.bsp.pdf.gua.JParseoGua;
...
public class JParseoGuatemala  extends JParseoGua implements IFinderGua, IBspSititaParser {

	
	public JParseoGuatemala() {
