...
public class JParseoGua2 implements IParseo {
	...
	BizGuaImpuesto impuesto = null;
	BizGuaImpuesto impuesto2 = null;
	BizGuaImpuesto impuesto3 = null;
	...
	public void addListenerDetect(IFinder finder) {
		this.finder = (IFinderGua2) finder;
	}
	...
	public boolean detectLinea(String linea) throws Exception {
	  ...
	  impuesto2 = new BizGuaImpuesto();
	  impuesto3 = new BizGuaImpuesto();
...
//		if ((s1 = linea.indexOf("    ", start)) == -1) return;
	...
	private Date getFecha(String linea) throws Exception {
	 ...
	 public  Date getFechaDDMMMAA(String linea) throws Exception {
	  	...
	  	else if (fecha.indexOf("AUG")!=-1) mes=Calendar.APRIL;
	...
	public static void main(String[] args) {
		JParseoGua2 parser = new JParseoGua2();
		IFinderGua2 finder = new IFinderGua2() {
