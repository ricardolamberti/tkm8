...
import pss.bsp.pdf.IReembolsables;
...
public class BizMexDetalle extends JRecord implements IConciliable,IReembolsables {
	...
	private JFloat pNeto=new JFloat()  {
		public void preset() throws Exception {
			pNeto.setValue(JTools.rd(pTarifaSinComision.getValue()-pImpuesto1.getValue()-pImpuesto2.getValue(),2));
			}	};
...
//=== CAMPOS ADICIONALES DEL EXCEL BSP (HOJA GRAL) ===

private JString pAGTN = new JString();
private JString pRPSI = new JString();
private JString pCAT = new JString();
private JString pCLASS = new JString();
private JString pCDGT = new JString();
private JString pCPUI = new JString();
private JString pCUTP = new JString();
private JFloat pSPRT = new JFloat();
private JFloat pEFCO = new JFloat();
private JFloat pEFRT = new JFloat();
private JFloat pCOAM = new JFloat();
private JFloat pCORT = new JFloat();
private JString pREMT = new JString();
private JFloat pTOCA = new JFloat();
private JFloat pSPAN = new JFloat();
private JFloat pFEES = new JFloat();
private JFloat pPEN = new JFloat();
private JString pNRID = new JString();
private JString pNRMETH = new JString();
private JString pTOUR = new JString();
private JString pWAVR = new JString();
private JString pRELT1 = new JString();
private JString pRTDN1 = new JString();
private JString pBoletoRfnd = new JString();
private JString pRTCP1 = new JString();
private JString pRELT2 = new JString();
private JString pRTDN2 = new JString();
private JString pRTCP2 = new JString();
private JString pICDN = new JString();
private JString pESAC = new JString();
private JString pTXCALC = new JString();
private JString pTRANSID = new JString();
private JString pCCVR = new JString();
private JString pTRNC = new JString();
private JString pTDNR = new JString();
private JString pDAIS = new JString();
private JString pSTAT = new JString();
private JString pTACN = new JString();
private JFloat pCOBL = new JFloat();
private JFloat pTAX = new JFloat();
private JFloat pCASH = new JFloat();
private JFloat pCRED = new JFloat();
private JString pDET = new JString();
	...
	public void setFecha(Date zValue) throws Exception {
		...
		pPeriodo.setValue(JDateTools.buildPeriod(zValue));
	}
...
public void setImpSobrecom(double zValue) throws Exception {
	...
	public double getTotalReembolso() throws Exception {
		return pCRED.getValue()+pCASH.getValue();
	}
	...
	public void setAGTN(String zValue) throws Exception { pAGTN.setValue(zValue); }
	public String getAGTN() throws Exception { return pAGTN.getValue(); }

	public void setRPSI(String zValue) throws Exception { pRPSI.setValue(zValue); }
	public String getRPSI() throws Exception { return pRPSI.getValue(); }

	public void setCAT(String zValue) throws Exception { pCAT.setValue(zValue); }
	public String getCAT() throws Exception { return pCAT.getValue(); }

	public void setCLASS(String zValue) throws Exception { pCLASS.setValue(zValue); }
	public String getCLASS() throws Exception { return pCLASS.getValue(); }

	public void setCDGT(String zValue) throws Exception { pCDGT.setValue(zValue); }
	public String getCDGT() throws Exception { return pCDGT.getValue(); }

	public void setCPUI(String zValue) throws Exception { pCPUI.setValue(zValue); }
	public String getCPUI() throws Exception { return pCPUI.getValue(); }

	public void setCUTP(String zValue) throws Exception { pCUTP.setValue(zValue); }
	public String getCUTP() throws Exception { return pCUTP.getValue(); }

	public void setSPRT(double zValue) throws Exception { pSPRT.setValue(zValue); }
	public double getSPRT() throws Exception { return pSPRT.getValue(); }

	public void setEFRT(double zValue) throws Exception { pEFRT.setValue(zValue); }
	public double getEFRT() throws Exception { return pEFRT.getValue(); }
	public void setEFCO(double zValue) throws Exception { pEFCO.setValue(zValue); }
	public double getEFCO() throws Exception { return pEFCO.getValue(); }
	public void setCORT(double zValue) throws Exception { pCORT.setValue(zValue); }
	public double getCORT() throws Exception { return pCORT.getValue(); }
	public void setCOAM(double zValue) throws Exception { pCOAM.setValue(zValue); }
	public double getCOAM() throws Exception { return pCOAM.getValue(); }
	public void setSPAN(double zValue) throws Exception { pSPAN.setValue(zValue); }
	public double getSPAN() throws Exception { return pSPAN.getValue(); }

	public void setREMT(String zValue) throws Exception { pREMT.setValue(zValue); }
	public String getREMT() throws Exception { return pREMT.getValue(); }

	public void setTOCA(double zValue) throws Exception { pTOCA.setValue(zValue); }
	public double getTOCA() throws Exception { return pTOCA.getValue(); }

	public void setFEES(double zValue) throws Exception { pFEES.setValue(zValue); }
	public double getFEES() throws Exception { return pFEES.getValue(); }

	public void setPEN(double zValue) throws Exception { pPEN.setValue(zValue); }
	public double getPEN() throws Exception { return pPEN.getValue(); }

	public void setNRID(String zValue) throws Exception { pNRID.setValue(zValue); }
	public String getNRID() throws Exception { return pNRID.getValue(); }

	public void setNRMETH(String zValue) throws Exception { pNRMETH.setValue(zValue); }
	public String getNRMETH() throws Exception { return pNRMETH.getValue(); }

	public void setTOUR(String zValue) throws Exception { pTOUR.setValue(zValue); }
	public String getTOUR() throws Exception { return pTOUR.getValue(); }

	public void setWAVR(String zValue) throws Exception { pWAVR.setValue(zValue); }
	public String getWAVR() throws Exception { return pWAVR.getValue(); }

	public void setRELT1(String zValue) throws Exception { pRELT1.setValue(zValue); }
	public String getRELT1() throws Exception { return pRELT1.getValue(); }

	public void setRTDN1(String zValue) throws Exception {
		pRTDN1.setValue(zValue); 
		pBoletoRfnd.setValue( zValue.length()<4?"":zValue.substring(3));
		
	
	}
	public String getRTDN1() throws Exception { return pRTDN1.getValue(); }

	public void setBoletoRfnd(String zValue) throws Exception { pBoletoRfnd.setValue(zValue); }
	public String getBoletoRfnd() throws Exception { return pBoletoRfnd.getValue(); }

	public void setRTCP1(String zValue) throws Exception { pRTCP1.setValue(zValue); }
	public String getRTCP1() throws Exception { return pRTCP1.getValue(); }

	public void setRELT2(String zValue) throws Exception { pRELT2.setValue(zValue); }
	public String getRELT2() throws Exception { return pRELT2.getValue(); }

	public void setRTDN2(String zValue) throws Exception { pRTDN2.setValue(zValue); }
	public String getRTDN2() throws Exception { return pRTDN2.getValue(); }

	public void setRTCP2(String zValue) throws Exception { pRTCP2.setValue(zValue); }
	public String getRTCP2() throws Exception { return pRTCP2.getValue(); }

	public void setICDN(String zValue) throws Exception { pICDN.setValue(zValue); }
	public String getICDN() throws Exception { return pICDN.getValue(); }

	public void setESAC(String zValue) throws Exception { pESAC.setValue(zValue); }
	public String getESAC() throws Exception { return pESAC.getValue(); }

	public void setTXCALC(String zValue) throws Exception { pTXCALC.setValue(zValue); }
	public String getTXCALC() throws Exception { return pTXCALC.getValue(); }

	public void setTRANSID(String zValue) throws Exception { pTRANSID.setValue(zValue); }
	public String getTRANSID() throws Exception { return pTRANSID.getValue(); }

	public void setCCVR(String zValue) throws Exception { pCCVR.setValue(zValue); }
	public String getCCVR() throws Exception { return pCCVR.getValue(); }

	public double getIva() throws Exception {
		return this.getImpuesto1()+this.getImpuesto2();
	}
	public void setTRNC(String zValue) throws Exception {
		pTRNC.setValue(zValue);
	}

	public String getTRNC() throws Exception {
		return pTRNC.getValue();
	}

	public void setTDNR(String zValue) throws Exception {
		pTDNR.setValue(zValue);
	}

	public String getTDNR() throws Exception {
		return pTDNR.getValue();
	}

	public void setDAIS(String zValue) throws Exception {
		pDAIS.setValue(zValue);
	}

	public String getDAIS() throws Exception {
		return pDAIS.getValue();
	}

	public void setSTAT(String zValue) throws Exception {
		pSTAT.setValue(zValue);
	}
	...
	public void setTACN(String zValue) throws Exception {
		pTACN.setValue(zValue);
	}
	...
	public void setCOBL(double zValue) throws Exception {
		pCOBL.setValue(zValue);
	}

	public double getCOBL() throws Exception {
		return pCOBL.getValue();
	}

	public void setTAX(double zValue) throws Exception {
		pTAX.setValue(zValue);
	}
	...
	public void setCASH(double zValue) throws Exception {
		pCASH.setValue(zValue);
	}

	public double getCASH() throws Exception {
		return pCASH.getValue();
	}

	public void setCRED(double zValue) throws Exception {
		pCRED.setValue(zValue);
	}

	public double getCRED() throws Exception {
		return pCRED.getValue();
	}

	public void setDET(String zValue) throws Exception {
		pDET.setValue(zValue);
	}

	public String getDET() throws Exception {
		return pDET.getValue();
	}

	/**
	 * Constructor de la Clase
	 */
	public BizMexDetalle() throws Exception {
	}
	...
	public void createProperties() throws Exception {
		...
		this.addItem("agtn", pAGTN);
		this.addItem("rpsi", pRPSI);
		this.addItem("cat", pCAT);
		this.addItem("aclass", pCLASS);
		this.addItem("cdgt", pCDGT);
		this.addItem("cpui", pCPUI);
		this.addItem("cutp", pCUTP);
		this.addItem("sprt", pSPRT);
		this.addItem("efco", pEFCO);
		this.addItem("efrt", pEFRT);
		this.addItem("coam", pCOAM);
		this.addItem("cort", pCORT);
		this.addItem("span", pSPAN);
		this.addItem("remt", pREMT);
		this.addItem("toca", pTOCA);
		this.addItem("fees", pFEES);
		this.addItem("pen", pPEN);
		this.addItem("nrid", pNRID);
		this.addItem("nrmeth", pNRMETH);
		this.addItem("tour", pTOUR);
		this.addItem("wavr", pWAVR);
		this.addItem("relt1", pRELT1);
		this.addItem("rtdn1", pRTDN1);
		this.addItem("rtcp1", pRTCP1);
		this.addItem("relt2", pRELT2);
		this.addItem("rtdn2", pRTDN2);
		this.addItem("rtcp2", pRTCP2);
		this.addItem("icdn", pICDN);
		this.addItem("esac", pESAC);
		this.addItem("txcalc", pTXCALC);
		this.addItem("transid", pTRANSID);
		this.addItem("ccvr", pCCVR);
		this.addItem("TRNC", pTRNC);
		this.addItem("TDNR", pTDNR);
		this.addItem("DAIS", pDAIS);
		this.addItem("STAT", pSTAT);
		this.addItem("TACN", pTACN);
		this.addItem("COBL", pCOBL);
		this.addItem("TAX", pTAX);
		this.addItem("CASH", pCASH);
		this.addItem("CRED", pCRED);
		this.addItem("DET", pDET);
		this.addItem("DK", pDK);
		this.addItem("boleto_rfnd", pBoletoRfnd);
	...
	public void createFixedProperties() throws Exception {
		...
		this.addFixedItem(FIELD, "periodo", "Período", true, false, 50);
		...
		this.addFixedItem(FIELD, "observaciones", "Observaciones", true, false, 350);
		...
		this.addFixedItem(FIELD, "agtn", "Agtn", true, false, 100);
		this.addFixedItem(FIELD, "rpsi", "Rpsi", true, false, 100);
		this.addFixedItem(FIELD, "cat", "Cat", true, false, 100);
		this.addFixedItem(FIELD, "aclass", "Class", true, false, 100);
		this.addFixedItem(FIELD, "cdgt", "Cdgt", true, false, 100);
		this.addFixedItem(FIELD, "cpui", "Cpui", true, false, 100);
		this.addFixedItem(FIELD, "cutp", "Cutp", true, false, 100);
		this.addFixedItem(FIELD, "sprt", "Sprt", true, false, 18, 2);
		this.addFixedItem(FIELD, "cort", "Cort", true, false, 18, 2);
		this.addFixedItem(FIELD, "coam", "Coam", true, false, 18, 2);
		this.addFixedItem(FIELD, "efrt", "Efrt", true, false, 18, 2);
		this.addFixedItem(FIELD, "efco", "Efco", true, false, 18, 2);
		this.addFixedItem(FIELD, "span", "span", true, false, 18, 2);
			this.addFixedItem(FIELD, "remt", "Remt", true, false, 100);
		this.addFixedItem(FIELD, "toca", "Toca", true, false, 18,2);
		this.addFixedItem(FIELD, "fees", "Fees", true, false, 18, 2);
		this.addFixedItem(FIELD, "pen", "Pen", true, false, 18, 2);
		this.addFixedItem(FIELD, "nrid", "Nrid", true, false, 100);
		this.addFixedItem(FIELD, "nrmeth", "Nrmeth", true, false, 100);
		this.addFixedItem(FIELD, "tour", "Tour", true, false, 100);
		this.addFixedItem(FIELD, "wavr", "Wavr", true, false, 100);
		this.addFixedItem(FIELD, "relt1", "Relt1", true, false, 100);
		this.addFixedItem(FIELD, "rtdn1", "Rtdn1", true, false, 100);
		this.addFixedItem(FIELD, "rtcp1", "Rtcp1", true, false, 100);
		this.addFixedItem(FIELD, "relt2", "Relt2", true, false, 100);
		this.addFixedItem(FIELD, "rtdn2", "Rtdn2", true, false, 100);
		this.addFixedItem(FIELD, "rtcp2", "Rtcp2", true, false, 100);
		this.addFixedItem(FIELD, "icdn", "Icdn", true, false, 100);
		this.addFixedItem(FIELD, "esac", "Esac", true, false, 100);
		this.addFixedItem(FIELD, "txcalc", "Txcalc", true, false, 100);
		this.addFixedItem(FIELD, "transid", "Transid", true, false, 100);
		this.addFixedItem(FIELD, "ccvr", "Ccvr", true, false, 100);
		this.addFixedItem(FIELD, "det", "DET", true, false, 50);
		this.addFixedItem(FIELD, "tacn", "TACN", true, false, 50);
		this.addFixedItem(FIELD, "trnc", "TRNC", true, false, 50);
		this.addFixedItem(FIELD, "tdnr", "TDNR", true, false, 50);
		this.addFixedItem(FIELD, "dais", "DAIS", true, false, 50);
		this.addFixedItem(FIELD, "stat", "STAT", true, false, 18, 2);
		this.addFixedItem(FIELD, "cobl", "COBL", true, false, 18, 2);
		this.addFixedItem(FIELD, "tax", "TAX", true, false, 18, 2);
		this.addFixedItem(FIELD, "cash", "CASH", true, false, 18, 2);
		this.addFixedItem(FIELD, "cred", "CRED", true, false, 18, 2);
		this.addFixedItem(FIELD, "dk", "DK", true, false, 18, 2);
		this.addFixedItem(FIELD, "boleto_rfnd", "Boleto rfnd", true, false, 18, 2);
	
	}

	public void attachRelationMap(JRelations rels) throws Exception {
  	rels.setSourceWinsClass("pss.bsp.pdf.mex.detalle.GuiMexDetalles");
  	JRelation rel; 
  	
  	rel = rels.addRelationForce(10, "restriccion usuario");
   	rel.addFilter(" (BSP_PDF_MEX_DETALLE.company is null or BSP_PDF_MEX_DETALLE.company in (COMPANY_CUSTOMLIST)) ");
...
//  	rel.addJoin("BSP_PDF_ARG_DETALLE.owner", BizUsuario.getUsr().GetUsuario());
  	...
  	rel.addJoin("BSP_PDF_MEX_DETALLE.company", "TUR_PNR_BOLETO.company");
  	rel.addJoin("BSP_PDF_MEX_DETALLE.boleto", "TUR_PNR_BOLETO.NumeroBoleto");
...
//		addFilter("owner", zOwner);
	...
	public boolean read(String zCompany,  String nroboleto) throws Exception {
		addFilter("company", zCompany);
		addFilter("boleto", nroboleto);
		return read();
	}
	...
	public Double getDoubleValue(String field, String moneda, boolean check) throws Exception {
		if (field.equals(IConciliable.COMISION)) return new Double((getTRNC().equals("RFND")?-1:1)*getComision());
		if (field.equals(IConciliable.COMISION_OVER)) return new Double((getTRNC().equals("RFND")?-1:1)*(getEFCO()));
		if (field.equals(IConciliable.COMISION_PORC)) return new Double(getEFRT());
		...
		if (field.equals(IConciliable.IMP_SOBRE_COMISION_INV)) return new Double((getTRNC().equals("RFND")?-1:1)*getImpSobrecomInv());
		if (field.equals(IConciliable.TOTALAPAGAR)) return new Double(JTools.rd((getTRNC().equals("RFND")?-1:1)*getTotal(),2));
		if (field.equals(IConciliable.TOTAL)) return new Double(JTools.rd((getTRNC().equals("RFND")?-1:1)*(getTotal()+getCRED()),2));
		if (field.equals(IConciliable.BASE_IMPONIBLE)) return new Double((getTRNC().equals("RFND")?-1:1)*getCOBL());
		...
		if (field.equals(IConciliable.IMPUESTO_1)) return new Double((getTRNC().equals("RFND")?-1:1)*getImpuesto1());
		if (field.equals(IConciliable.IMPUESTO_2)) return new Double((getTRNC().equals("RFND")?-1:1)*getImpuesto2());
		if (field.equals(IConciliable.IMPUESTO_ACUM)) return new Double((getTRNC().equals("RFND")?-1:1)*(getImpuestoAcum()+getPEN()));
		if (field.equals(IConciliable.TARIFA)) return new Double((getTRNC().equals("RFND")?-1:1)*getCOBL());
		if (field.equals(IConciliable.TARJETA)) return new Double((getTRNC().equals("RFND")?-1:1)*getTarjeta());
		if (field.equals(IConciliable.TARJETA_BRUTO)) return new Double((getTRNC().equals("RFND")?-1:1)*getCRED());
		if (field.equals(IConciliable.CONTADO_BRUTO)) return new Double((getTRNC().equals("RFND")?-1:1)*getCASH());
		if (field.equals(IConciliable.NETO)) return new Double((getTRNC().equals("RFND")?-1:1)*getNeto());
		if (field.equals(IConciliable.COMISION_ACUM)) return new Double(getEFCO());
		if (field.equals(IConciliable.COMISION_ACUM_INV)) return new Double(-getEFCO());
		if (field.equals(IConciliable.TARIFA_SIN_COMISION)) return new Double((getTRNC().equals("RFND")?-1:1)*getTarifaSinComision());
		return null;
	}

	public String getStringValue(String field, boolean check) throws Exception {
		if (field.equals(IConciliable.BOLETOS)) return getTRNC().equals("RFND")?getBoletoRfnd(): getBoleto();
	...
	BizMexCabecera objCabecera;
	
	public BizMexCabecera getObjCabecera() throws Exception {
		if (objCabecera!=null) return objCabecera;
		BizMexCabecera cab = new BizMexCabecera();
		cab.dontThrowException(true);
		if (!cab.read(getCompany(), getIdpdf())) return  null;
		return objCabecera=cab;
	}

	@Override
	public boolean isRefund() throws Exception {
		return getTRNC().equals("RFND");
	}
	...
	public void completeDK() throws Exception {
		String sql2="UPDATE bsp_pdf_mex_detalle d "
				+ "SET dk = b.dk "
				+ "FROM bsp_liquidation_detail b "
				+ "WHERE d.dk IS NULL "
				+ "  AND d.trnc NOT IN ('RFND', 'ACMA', 'ADMA') "
				+ "  AND d.boleto = b.nro_boleto "
				+ "  AND d.company = b.company; ";
		String sql1="UPDATE bsp_pdf_mex_detalle d "
				+ "SET dk = b.dk  "
				+ "FROM bsp_liquidation_detail b "
				+ "WHERE d.dk IS NULL "
				+ "  AND d.trnc IN ('RFND', 'ACMA', 'ADMA') "
				+ "  AND d.boleto_rfnd = b.nro_boleto "
				+ "  AND d.company = b.company; ";
		boolean trxOwner=	!JBDatos.GetBases().getPrivateCurrentDatabase().isTransactionInProgress();
		
		try {
			if (trxOwner)
				JBDatos.GetBases().getPrivateCurrentDatabase().beginTransaction();
			JBaseRegistro reg1=JBaseRegistro.VirtualCreate();
			reg1.Execute(sql1);
			JBaseRegistro reg2=JBaseRegistro.VirtualCreate();
			reg2.Execute(sql2);
			JRecords<BizMexDetalle> recs = new JRecords<BizMexDetalle>(BizMexDetalle.class);
			recs.addFilter("dk", "null");
			recs.addFilter("TRNC", "null","<>");
			JIterator<BizMexDetalle> it = recs.getStaticIterator();
			String boletos="";
			Map<String,BizMexDetalle> map = new TreeMap<String,BizMexDetalle>();
			while (it.hasMoreElements()) {
				BizMexDetalle mex = it.nextElement();
				if (mex.getTRNC().equals("RFND") ||mex.getTRNC().equals("ACMA")||mex.getTRNC().equals("ADMA"))
					boletos+=(boletos.equals("")?"":",")+"'"+mex.getBoletoRfnd()+"'";
				else
					boletos+=(boletos.equals("")?"":",")+"'"+mex.getBoleto()+"'";
				map.put(mex.getBoleto(),mex);
				if (boletos.length()>1000) {
					actualizarBoletos(boletos,map);	

					boletos="";
					map = new TreeMap<String,BizMexDetalle>();
				}
			}
			if (!boletos.equals("")) {
				actualizarBoletos(boletos,map);	
	...
	private void actualizarBoletos(String boletos, Map<String, BizMexDetalle> map) throws Exception {
    JRecords<BizTrxOra> tks = new JRecords<>(BizTrxOra.class);
    tks.addFixedFilter("boleto in (" + boletos + ")");
    JIterator<BizTrxOra> ito = tks.getStaticIterator();
    while (ito.hasMoreElements()) {
        BizTrxOra trk = ito.nextElement();
        BizMexDetalle mexA = map.get(trk.getBoleto());
        if (mexA != null) {
            mexA.setDK(trk.getDk());
            mexA.update();
        }
    }
}
