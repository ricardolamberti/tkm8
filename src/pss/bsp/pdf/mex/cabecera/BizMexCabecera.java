...
public class BizMexCabecera extends JRecord implements IHeaderPDF {
  ...
  private JBoolean pFullData = new JBoolean();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void setFullData(boolean zValue) throws Exception {    pFullData.setValue(zValue);  }
  public boolean getFullData() throws Exception {     return pFullData.getValue();  }


  /**
   * Constructor de la Clase
   */
  public BizMexCabecera() throws Exception {
  }
  ...
  public void createProperties() throws Exception {
    ...
    this.addItem( "full_data", pFullData );
  ...
  public void createFixedProperties() throws Exception {
    ...
    this.addFixedItem( FIELD, "full_data", "Datos extendidos", true, false, 1 );
   ...
   */
  public String GetTable() { return "BSP_PDF_MEX_CABECERA"; }
