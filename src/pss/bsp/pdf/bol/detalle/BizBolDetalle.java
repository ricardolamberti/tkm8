...
public class BizBolDetalle extends JRecord implements IConciliable {
...
public void setImpSobrecom(double zValue) throws Exception {
	 ...
	 */
	public BizBolDetalle() throws Exception {
	}
	...
	public void attachRelationMap(JRelations rels) throws Exception {
  	rels.setSourceWinsClass("pss.bsp.pdf.bol.detalle.GuiArgDetalles");
  	JRelation rel; 
  	
  	rel = rels.addRelationForce(10, "restriccion usuario");
   	rel.addFilter(" (BSP_PDF_BOL_DETALLE.company is null or BSP_PDF_BOL_DETALLE.company in (COMPANY_CUSTOMLIST)) ");
...
//  	rel.addJoin("BSP_PDF_ARG_DETALLE.owner", BizUsuario.getUsr().GetUsuario());
  	...
  	rel.addJoin("BSP_PDF_BOL_DETALLE.company", "TUR_PNR_BOLETO.company");
  	rel.addJoin("BSP_PDF_BOL_DETALLE.boleto", "TUR_PNR_BOLETO.NumeroBoleto");
