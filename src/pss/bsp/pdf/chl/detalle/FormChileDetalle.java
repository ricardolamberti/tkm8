...
public class FormChileDetalle extends JBaseForm {

  private static final long serialVersionUID = 1245253775814L;

  public FormChileDetalle() throws Exception {}

  public GuiChileDetalle getWin() { return (GuiChileDetalle) getBaseWin(); }
