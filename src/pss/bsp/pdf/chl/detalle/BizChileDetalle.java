...
public class BizChileDetalle extends JRecord implements IConciliable {
...
public void setImpSobrecom(double zValue) throws Exception {
	 ...
	 */
	public BizChileDetalle() throws Exception {
	}
	...
	public void attachRelationMap(JRelations rels) throws Exception {
  	rels.setSourceWinsClass("pss.bsp.pdf.chl.detalle.GuiChileDetalles");
  	JRelation rel; 
  	
  	rel = rels.addRelationForce(10, "restriccion usuario");
   	rel.addFilter(" (BSP_PDF_CHL_DETALLE.company in (COMPANY_CUSTOMLIST)) ");
// 	rel.addJoin("BSP_PDF_CHL_DETALLE.company", BizUsuario.getUsr().getCompany());
//  	rel.addJoin("BSP_PDF_CHL_DETALLE.owner", BizUsuario.getUsr().GetUsuario());
	  
   	rel=rels.addRelationParent(40, "PNRs", BizPNRTicket.class, "boleto");
  	rel.addJoin("BSP_PDF_CHL_DETALLE.company", "TUR_PNR_BOLETO.company");
  	rel.addJoin("BSP_PDF_CHL_DETALLE.boleto", "TUR_PNR_BOLETO.NumeroBoleto");
  	rel.setTypeJoin(JRelations.JOIN_LEFT);

//   	rel=rels.addRelationParent(50, "BOs", BizBODetalle.class, "boleto");
//  	rel.addJoin("BSP_PDF_CHL_DETALLE.company", "BSP_BO_DETALLE.company");
//  	rel.addJoin("BSP_PDF_CHL_DETALLE.boleto", "BSP_BO_DETALLE.boleto");
//  	rel.setTypeJoin(JRelations.JOIN_LEFT);
...
//		addFilter("owner", zOwner);
	...
	public String getStringValue(String field, boolean check) throws Exception {
		if (field.equals(IConciliable.MONEDA)) return getMoneda();
