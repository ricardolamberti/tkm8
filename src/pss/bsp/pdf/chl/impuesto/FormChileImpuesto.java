...
public class FormChileImpuesto extends JBaseForm {
...
JPssEdit tarjeta = new JPssEdit  ();
   ...
   */
  public FormChileImpuesto() throws Exception {
    try { jbInit(); }
    catch (Exception e) { e.printStackTrace(); } 
  }

  public GuiChileImpuesto getWin() { return (GuiChileImpuesto) getBaseWin(); }
