...
public class GuiChileImpuestos extends JWins {
   ...
   */
  public GuiChileImpuestos() throws Exception {
  }


  public int     GetNroIcono() throws Exception  { return 10049; } 
  public String  GetTitle()    throws Exception  { return "Impuestos"; }
  public Class<? extends JWin>  GetClassWin()                   { return GuiChileImpuesto.class; }
  /**
