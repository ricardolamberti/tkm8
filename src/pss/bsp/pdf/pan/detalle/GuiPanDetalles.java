...
public class GuiPanDetalles extends JWins {
...
//    addActionNew( 1, "Nuevo Registro" );
  ...
  public void ConfigurarColumnasLista(JWinList zLista) throws Exception {
	...
	public void createTotalizer(JWinList oLista) throws Exception {
		oLista.addTotalizerText("fecha", "Totales"); // un texto
		oLista.addTotalizer("tarifa", 2, JTotalizer.OPER_SUM); // la suma del
		oLista.addTotalizer("contado", 2, JTotalizer.OPER_SUM); // la suma del
		oLista.addTotalizer("tarjeta", 2, JTotalizer.OPER_SUM); // la suma del
		oLista.addTotalizer("base_imponible", 2, JTotalizer.OPER_SUM); // la suma del
		//oLista.addTotalizer("neto", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("impuesto1", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("impuesto2", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("comision", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("comision_over", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("imp_sobre_com", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("total", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("contado_bruto", 2, JTotalizer.OPER_SUM); // la suma del campo
		oLista.addTotalizer("tarjeta_bruto", 2, JTotalizer.OPER_SUM); // la suma del campo
	}
	@Override
