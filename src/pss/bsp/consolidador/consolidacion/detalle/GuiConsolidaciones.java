...
public class GuiConsolidaciones extends JWins {
 ...
 //   addActionNew( 1, "Nuevo Registro" );
	...
	public void ConfigurarFiltros(JFormFiltro zFiltros) throws Exception {
		...
		if (GetVision().equals(BizConsolidacion.VISION_LIBRE)) {
	...
	private JWins getTiposStatus() throws Exception {
		return JWins.CreateVirtualWins(BizConsolidacion.ObtenerResultadosConsolidacion());
	}
...
//    super.ConfigurarColumnasLista(zLista);
  ...
  //	zLista.AddColumnaLista(IConciliable.COMISION,"d11" );
  	...
  	zLista.AddColumnaLista("Situación","Situation" );
  	...
  	zLista.AddColumnaLista("Contrato","contrato" );
